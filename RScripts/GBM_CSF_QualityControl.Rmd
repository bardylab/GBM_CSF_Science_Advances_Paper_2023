...
save(Seurat_111, file =  paste0(datadirectory, "/RData/Individual Cell Line RData/Prefiler_and_combined_RData/SANTB00111/RData/Prefilter_SANTB00111.RData/"))
```
...
## Let’s quickly do some plotting to look at the number of reads per cell and detected/expressed genes per cell (often called complexity)
...
hist
ggsave(hist, file = paste(datadirectory, "/RData/Individual Cell Line RData/Prefiler_and_combined_RData/SANTB00111/plots/Seurat_111_reads_per_cell_beforefiltering.pdf", sep = "/"), width = 10, height = 6)
...
hist2
ggsave(hist2, file = paste(datadirectory, "/RData/Individual Cell Line RData/Prefiler_and_combined_RData/SANTB00111/plots/Seurat_111_genes_per_cell_beforefiltering.pdf", sep = "/"), width = 10, height = 6)
```
...
scatterPlot
ggsave(scatterPlot, filename = paste(datadirectory, "/RData/Individual Cell Line RData/Prefiler_and_combined_RData/SANTB00111/plots/PreQC_SANTB00111_UMIcounts_versus_genesdetected_per_cell_legend.pdf", sep = "/"), height = 6, width = 6, dpi = 300, useDingbats = FALSE)
...
scatterPlot
ggsave(scatterPlot, filename = paste(datadirectory, "/RData/Individual Cell Line RData/Prefiler_and_combined_RData/SANTB00111/plots/PreQC_SANTB00111_genesdetected_versus_percentmtreads_per_cell_nolegend.pdf", sep = "/"), height = 6, width = 6, dpi = 300, useDingbats = FALSE)
...
scatterPlot <- ggplot(SANTB00111@meta.data, aes(x = nCount_RNA, y = percent.mt)) +
  ...
  geom_vline(xintercept = 55000, linetype = "dashed", col = "red", size = 1)
scatterPlot
ggsave(scatterPlot, filename = paste(datadirectory, "/RData/Individual Cell Line RData/Prefiler_and_combined_RData/SANTB00111/plots/PreQC_SANTB00111_umicounts_versus_percentmtreads_per_cell_nolegend.pdf", sep = "/"), height = 6, width = 6, dpi = 300, useDingbats = FALSE)
...
scatterPlot <- ggplot(SANTB00111@meta.data, aes(x = nFeature_RNA, y = n.exp.hkgenes)) +
  ...
  geom_vline(xintercept = 2000, linetype = "dashed", col = "red", size = 1)
scatterPlot
ggsave(scatterPlot, filename = paste(datadirectory, "/RData/Individual Cell Line RData/Prefiler_and_combined_RData/SANTB00111/plots/PreQC_SANTB00111_genesdetected_versus_nexpHKgenes_per_cell_nolegend.pdf", sep = "/"), height = 6, width = 6, dpi = 300, useDingbats = FALSE)
...
scatterPlot <- ggplot(SANTB00111@meta.data, aes(x = nCount_RNA, y = n.exp.hkgenes)) +
  ...
  geom_vline(xintercept = 55000, linetype = "dashed", col = "red", size = 1)
scatterPlot
ggsave(scatterPlot, filename = paste(datadirectory, "/RData/Individual Cell Line RData/Prefiler_and_combined_RData/SANTB00111/plots/PreQC_SANTB00111_umicounts_versus_nexpHKgenes_per_cell_nolegend.pdf", sep = "/"), height = 6, width = 6, dpi = 300, useDingbats = FALSE)
```

5.  ***Now we filter out any dead cells and cells with low numbers of HK genes***

```{QC of Bardy Seurat Object}
...
scale_x_continuous(breaks = seq(0, 9000, by = 1000)) +
 ...
 geom_vline(xintercept = 2000, linetype = "dashed", col = "red", size = 1)
histoPlot
ggsave(histoPlot, filename = paste(datadirectory, "/RData/Individual Cell Line RData/Prefiler_and_combined_RData/SANTB00111/plots/SANTB00111_histogram_genes_per_cell_preQC.pdf", sep = "/"), height = 6, width = 10, dpi = 300, useDingbats = FALSE)
...
save(SANTB00111, file = paste(datadirectory, "/RData/Individual Cell Line RData/Prefiler_and_combined_RData/SANTB00111/RData/SANTB00111_PreQC.Rdata"))
save(SANTB00111_QC, file = paste(datadirectory, "/RData/Individual Cell Line RData/Prefiler_and_combined_RData/SANTB00111/RData/SANTB00111_QC.Rdata"))
```
