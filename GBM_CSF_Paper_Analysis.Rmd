...
subset.matrix <- seurat_cluster.averages[["RNA"]][c("NUPR1","DRD1","DRD2","DRD4","CALM1", "CALM2","CALM3","ADRA1A","CALY","S100A4","TNNC1","NR3C1","ADRB2","TSHR","THRB","CAMK1","CAMK1D","CAMK1G","CAMK2A","CAMK4","CAMKK1","CAMKK2","TRIB1","TRIB2","TRIB3"),] ## this is the list that will be used by Brett
